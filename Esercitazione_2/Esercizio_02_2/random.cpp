...
void Walker :: setx(double newX){
  
  x = newX;

}

void Walker :: sety(double newY){
  
  y = newY;

}

void Walker :: setz(double newZ){
  
  z = newZ;

}

double Walker :: getx() const {
   
   return x;
}

double Walker :: gety() const {
   
   return y;
}

double Walker :: getz() const {
