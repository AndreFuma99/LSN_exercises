...
// This class contains coordinates of a 3D random walker
class Walker {
...
public:
  ...
  void sety(double);
  // Method to set the z coordinate
  void setz(double);
  // Method to access the x coordinate
  double getx() const;
  // Method to access the y coordinate
  double gety() const;
  // Method to access the z coordinate
  double getz() const;
