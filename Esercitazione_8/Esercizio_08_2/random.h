...
// Function for statistical uncertainty estimation
  ...
  std::pair<double, double> calculate_H(Random &, double, double, int, int, double);
  // Questa funzione calcola il valore di aspettazione dell'Hamiltoniana e l'incertezza statistica utilizzando data blocking
