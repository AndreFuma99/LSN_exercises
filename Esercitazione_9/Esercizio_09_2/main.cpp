...
int main (int argc, char *argv[]){
   ...
   double p_m1 = 0.09;   // probabilità della prima mutazione
   double p_m2 = 0.08;   // probabilità della seconda mutazione
   double p_m3 = 0.08;   // probabilità della terza mutazione
   ...
   for (int i=0; i<120; i++){   // Faccio 120 generazioni perchè ho visto che dopo circa 85 L si stabilizza
